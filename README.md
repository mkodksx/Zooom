...
spawn(function()
    ...
    --------------------------------------------------------------------
local win = library:AddWindow("ZOOM","BloxFruits Remake",Enum.KeyCode.RightControl)
--Tab
...
spawn(function()
    ...
    Hub:AddSeperator("Ui ZoomHub test paid")
    
    Hub:AddButton("ZoomHub UI Test",function()
